...
describe('extractGoogleDocId', () => {
  it('pulls the id from an edit URL', () => {
    expect(
      extractGoogleDocId(
        'https://docs.google.com/document/d/1A2b3C4d5E6f7G8h9I0jKlMnOpQrStUvWx/edit#heading=x',
      ),
    ).toBe('1A2b3C4d5E6f7G8h9I0jKlMnOpQrStUvWx');
  });
  it('accepts a bare id', () => {
    expect(extractGoogleDocId('1A2b3C4d5E6f7G8h9I0jKlMnOpQrStUvWx')).toBe(
